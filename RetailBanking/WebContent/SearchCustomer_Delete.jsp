...
<body>
	...
	%>
	<div class="main">
		<form class="pure-form pure-form-aligned" action="CustomerSearch"
			method="post">
			<fieldset>
				<h1>Search Customer Screen</h1>
				<div class="pure-control-group">
					<label>Customer Aadhar ID</label> <input type="number"
						placeholder="Enter Aadhar ID" name="dcusAID" />
				</div>
				<br>
				...
				<div class="pure-controls">
					...
					<button class="button-error" type="reset" onclick="fall_back('Customer Search')" >Cancel</button>
				</div>
			</fieldset>
		</form>
	</div>
