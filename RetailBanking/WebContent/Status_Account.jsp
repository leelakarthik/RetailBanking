...
<body>
	...
	<div id="div">
		<table id="customers">
			...
			String q = "select * from accountstatus where timestamp in(  SELECT  MAX(TIMESTAMP) FROM accountstatus GROUP BY accountID ORDER BY TIMESTAMP DESC) ORDER by timestamp desc limit 15";
			//Statement s = null;
